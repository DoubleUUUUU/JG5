...
Write a loop that prints the multiplication table for the number 3 (3 * 1, 3 * 2, ..., 3 * 10) in an array to showcase.
*/
...
Write a loop that finds and prints the largest number in an array of numbers, that you define!
*/
